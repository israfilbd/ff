...
public class QsOpHeaderView extends LinearLayout
    ...
    private final KeyguardStateController keyguardController;
    ...
    public QsOpHeaderView(Context context, AttributeSet attrs) {
        ...
        keyguardController = Dependency.get(KeyguardStateController.class);
    ...
    private void initListeners() {
        ...
        keyguardController.addCallback(keyguardCallback);
        secureQS();
    }
    
    private void secureQS() {
        int requiresUnlocking = Settings.Secure.getInt(mContext.getContentResolver(), Settings.Secure.QSTILE_REQUIRES_UNLOCKING, 0);

        if (requiresUnlocking == 1 && keyguardController.isMethodSecure() && keyguardController.isShowing()) {
    ...
    private final KeyguardStateController.Callback keyguardCallback = new KeyguardStateController.Callback() {
        @Override
    ...
    private void initBluetoothManager() {
        ...
        if (localBluetoothManager != null) {
            ...
            synchronized (localBluetoothAdapter) {
                if (localBluetoothAdapter.getState() != localBluetoothAdapter.getBluetoothState()) {
                    localBluetoothAdapter.setBluetoothStateInt(localBluetoothAdapter.getState());
                }
    ...
    @Override
    public synchronized void onBluetoothStateChanged(@AdapterState int bluetoothState) {
        updateBluetoothState(bluetoothState);
    }
    ...
    private void updateBluetoothState(@AdapterState int bluetoothState) {
        mBluetoothEnabled = bluetoothState == BluetoothAdapter.STATE_ON
                || bluetoothState == BluetoothAdapter.STATE_TURNING_ON || mBluetoothController.isBluetoothEnabled();
        updateBluetoothTile();
    }
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v == mMediaBtnPrev || v == mMediaBtnPlayPause || v == mMediaBtnNext) {
    ...
    MediaController mediaController = mNotificationMediaManager.getMediaController();
    	if (mediaController != null && mediaController.getPlaybackState() != null) {
             return mediaController.getPlaybackState().getState() != PlaybackState.STATE_NONE;
    	}
        return false;
    }
	...
	return Settings.System.getIntForUser(mContext.getContentResolver(),
	       Settings.System.QS_TILES_HAPTIC_FEEDBACK, 0, UserHandle.USER_CURRENT) == 1;
    }
