...
public class VolumeDialogImpl implements VolumeDialog, Dumpable,
    ...
    private void setupAppVolumeIcon() {
        ...
        if (icon != null && mAppVolumeIcon != null) {
        mAppVolumeIcon.setImageTintList(null);
        mAppVolumeIcon.setImageDrawable(icon);

        ViewGroup.LayoutParams params = mAppVolumeIcon.getLayoutParams();
        if (params != null) {
            params.height = mTargetTapSize;
            params.width = mTargetTapSize;
            mAppVolumeIcon.setLayoutParams(params);
        }
    ...
    public void cleanup() {
    	if (mAppVolumeIcon != null) {
        	mAppVolumeIcon.setOnClickListener(null);
        	mAppVolumeIcon.setOnLongClickListener(null);
    	}
    }
