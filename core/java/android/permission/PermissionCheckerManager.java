...
public class PermissionCheckerManager {
    ...
    public PermissionCheckerManager(@NonNull Context context) {
        ...
        try {
            service = IPermissionChecker.Stub.asInterface(ServiceManager.getServiceOrThrow(
                    Context.PERMISSION_CHECKER_SERVICE));
        } catch (ServiceManager.ServiceNotFoundException e) {
            throw new RuntimeException("PermissionCheckerService not available", e);
        }
        mService = service;
    ...
    public int checkPermission(@NonNull String permission,
        ...
        if (mService == null) {
            Log.e("PermissionCheckerManager", "IPermissionChecker service is not initialized");
